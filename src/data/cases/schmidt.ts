...
/** Eric Schmidt — WSJ commencement clip (edit order ≠ speech order). */
export const schmidtCase: CaseStudy = {
  id: "schmidt",
  video: {
    youtubeId: "tNH43a1EI7s",
    durationSeconds: 122,
    title: "Eric Schmidt — Commencement address",
    subtitle: "WSJ clip (~2 min)",
    sourceUrl: "https://youtu.be/tNH43a1EI7s",
  },
  transcript: [
    {
      id: "seg-1",
